...
class BridgesResource(SyncAPIResource):
    ...
    @cached_property
    def logins(self) -> LoginsResource:
        """
        Available bridges, bridge logins, login sessions for connect and reconnect flows, and advanced network capabilities.
        """
        return LoginsResource(self._client)
...
class AsyncBridgesResource(AsyncAPIResource):
    ...
    @cached_property
    def logins(self) -> AsyncLoginsResource:
        """
        Available bridges, bridge logins, login sessions for connect and reconnect flows, and advanced network capabilities.
        """
        return AsyncLoginsResource(self._client)
...
class BridgesResourceWithRawResponse:
    ...
    @cached_property
    def logins(self) -> LoginsResourceWithRawResponse:
        """
        Available bridges, bridge logins, login sessions for connect and reconnect flows, and advanced network capabilities.
        """
        return LoginsResourceWithRawResponse(self._bridges.logins)
...
class AsyncBridgesResourceWithRawResponse:
    ...
    @cached_property
    def logins(self) -> AsyncLoginsResourceWithRawResponse:
        """
        Available bridges, bridge logins, login sessions for connect and reconnect flows, and advanced network capabilities.
        """
        return AsyncLoginsResourceWithRawResponse(self._bridges.logins)
...
class BridgesResourceWithStreamingResponse:
    ...
    @cached_property
    def logins(self) -> LoginsResourceWithStreamingResponse:
        """
        Available bridges, bridge logins, login sessions for connect and reconnect flows, and advanced network capabilities.
        """
        return LoginsResourceWithStreamingResponse(self._bridges.logins)
...
class AsyncBridgesResourceWithStreamingResponse:
    ...
    @cached_property
    def logins(self) -> AsyncLoginsResourceWithStreamingResponse:
        """
        Available bridges, bridge logins, login sessions for connect and reconnect flows, and advanced network capabilities.
        """
        return AsyncLoginsResourceWithStreamingResponse(self._bridges.logins)
