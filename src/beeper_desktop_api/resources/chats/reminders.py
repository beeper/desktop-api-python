...
from ...types.chats import reminder_create_params, reminder_delete_params
...
class RemindersResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        """
        return self._post(
            "/v0/set-chat-reminder",
            body=maybe_transform(
                {
                    "chat_id": chat_id,
                    "reminder": reminder,
                },
                reminder_create_params.ReminderCreateParams,
            ),
    ...
    def delete(
        ...
        *,
        ...
        """
        return self._post(
            "/v0/clear-chat-reminder",
            body=maybe_transform({"chat_id": chat_id}, reminder_delete_params.ReminderDeleteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BaseResponse,
...
class AsyncRemindersResource(AsyncAPIResource):
    ...
    async def delete(
        ...
        *,
        ...
        return await self._post(
            "/v0/clear-chat-reminder",
            body=await async_maybe_transform({"chat_id": chat_id}, reminder_delete_params.ReminderDeleteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BaseResponse,
