...
class MessagesResource(SyncAPIResource):
    ...
    def search(
        ...
        *,
        ...
        Args:
          account_ids: Limit search to specific Beeper account IDs (bridge instances).

          chat_ids: Limit search to specific Beeper chat IDs.
    ...
    def send(
        ...
        *,
        ...
        Args:
          chat_id: Unique identifier of the chat (a.k.a. room or thread).
