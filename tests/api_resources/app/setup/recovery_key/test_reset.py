...
class TestReset:
    ...
    def test_raw_response_create(self, client: BeeperDesktop) -> None:
        response = client.app.setup.recovery_key.reset.with_raw_response.create()
    ...
    def test_streaming_response_create(self, client: BeeperDesktop) -> None:
        with client.app.setup.recovery_key.reset.with_streaming_response.create() as response:
    ...
    def test_method_confirm(self, client: BeeperDesktop) -> None:
        reset = client.app.setup.recovery_key.reset.confirm(
            recovery_key="x",
        )
    ...
    def test_raw_response_confirm(self, client: BeeperDesktop) -> None:
        response = client.app.setup.recovery_key.reset.with_raw_response.confirm(
            recovery_key="x",
        )
    ...
    def test_streaming_response_confirm(self, client: BeeperDesktop) -> None:
        with client.app.setup.recovery_key.reset.with_streaming_response.confirm(
            recovery_key="x",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncReset:
    ...
    async def test_method_create(self, async_client: AsyncBeeperDesktop) -> None:
        reset = await async_client.app.setup.recovery_key.reset.create()
        assert_matches_type(ResetCreateResponse, reset, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncBeeperDesktop) -> None:
        response = await async_client.app.setup.recovery_key.reset.with_raw_response.create()
    ...
    async def test_streaming_response_create(self, async_client: AsyncBeeperDesktop) -> None:
        async with async_client.app.setup.recovery_key.reset.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_confirm(self, async_client: AsyncBeeperDesktop) -> None:
        reset = await async_client.app.setup.recovery_key.reset.confirm(
            recovery_key="x",
        )
        assert_matches_type(ResetConfirmResponse, reset, path=["response"])
    ...
    async def test_raw_response_confirm(self, async_client: AsyncBeeperDesktop) -> None:
        response = await async_client.app.setup.recovery_key.reset.with_raw_response.confirm(
            recovery_key="x",
        )
    ...
    async def test_streaming_response_confirm(self, async_client: AsyncBeeperDesktop) -> None:
        async with async_client.app.setup.recovery_key.reset.with_streaming_response.confirm(
            recovery_key="x",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
