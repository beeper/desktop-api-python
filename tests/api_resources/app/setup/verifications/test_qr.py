...
from beeper_desktop_api.types.app.setup.verifications import QRScanResponse, QRConfirmScannedResponse
...
class TestQR:
    ...
    def test_method_confirm_scanned(self, client: BeeperDesktop) -> None:
        qr = client.app.setup.verifications.qr.confirm_scanned(
            "x",
        )
    ...
    def test_raw_response_confirm_scanned(self, client: BeeperDesktop) -> None:
        response = client.app.setup.verifications.qr.with_raw_response.confirm_scanned(
            "x",
        )
    ...
    def test_streaming_response_confirm_scanned(self, client: BeeperDesktop) -> None:
        with client.app.setup.verifications.qr.with_streaming_response.confirm_scanned(
            "x",
        ) as response:
    ...
    def test_path_params_confirm_scanned(self, client: BeeperDesktop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `verification_id` but received ''"):
            client.app.setup.verifications.qr.with_raw_response.confirm_scanned(
                "",
            )

    @parametrize
    def test_method_scan(self, client: BeeperDesktop) -> None:
        qr = client.app.setup.verifications.qr.scan(
            data="x",
        )
    ...
    def test_raw_response_scan(self, client: BeeperDesktop) -> None:
        response = client.app.setup.verifications.qr.with_raw_response.scan(
            data="x",
        )
    ...
    def test_streaming_response_scan(self, client: BeeperDesktop) -> None:
        with client.app.setup.verifications.qr.with_streaming_response.scan(
            data="x",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncQR:
    ...
    async def test_method_confirm_scanned(self, async_client: AsyncBeeperDesktop) -> None:
        qr = await async_client.app.setup.verifications.qr.confirm_scanned(
            "x",
        )
        assert_matches_type(QRConfirmScannedResponse, qr, path=["response"])
    ...
    async def test_raw_response_confirm_scanned(self, async_client: AsyncBeeperDesktop) -> None:
        response = await async_client.app.setup.verifications.qr.with_raw_response.confirm_scanned(
            "x",
        )
    ...
    async def test_streaming_response_confirm_scanned(self, async_client: AsyncBeeperDesktop) -> None:
        async with async_client.app.setup.verifications.qr.with_streaming_response.confirm_scanned(
            "x",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_confirm_scanned(self, async_client: AsyncBeeperDesktop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `verification_id` but received ''"):
            await async_client.app.setup.verifications.qr.with_raw_response.confirm_scanned(
                "",
            )

    @parametrize
    async def test_method_scan(self, async_client: AsyncBeeperDesktop) -> None:
        qr = await async_client.app.setup.verifications.qr.scan(
            data="x",
        )
        assert_matches_type(QRScanResponse, qr, path=["response"])
    ...
    async def test_raw_response_scan(self, async_client: AsyncBeeperDesktop) -> None:
        response = await async_client.app.setup.verifications.qr.with_raw_response.scan(
            data="x",
        )
    ...
    async def test_streaming_response_scan(self, async_client: AsyncBeeperDesktop) -> None:
        async with async_client.app.setup.verifications.qr.with_streaming_response.scan(
            data="x",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
