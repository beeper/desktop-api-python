...
from beeper_desktop_api import BeeperDesktop, AsyncBeeperDesktop, APIResponseValidationError
...
class TestBeeperDesktop:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "beeper_desktop_api/_legacy_response.py",
                        "beeper_desktop_api/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "beeper_desktop_api/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: BeeperDesktop) -> None:
        request = client._build_request(
    ...
    def test_base_url_trailing_slash(self, client: BeeperDesktop) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: BeeperDesktop) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: BeeperDesktop) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = BeeperDesktop(base_url=base_url, access_token=access_token, _strict_response_validation=True)
    ...
    def test_omit_retry_count_header(
        self, client: BeeperDesktop, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncBeeperDesktop:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncBeeperDesktop) -> None:
        request = async_client._build_request(
            FinalRequestOptions.construct(
                method="post",
                url="/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncBeeperDesktop(
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncBeeperDesktop,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
